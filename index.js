...
function warnAboutMaxArrayLength(arr, maxLength) {
  ...
  else comsole.warn("Довжина масиву не перевищує максимально допустиму.");
}
...
function compareArrays(arr1, arr2) {
  ...
  console.assert(arr1 === arr2, "Mасиви не однакові");
}
...
function buildMatrix(size) {
  ...
  for (let i = 0; i < size; i++) {
    ...
    for (let j = 0; j < size; j++) {
      ...
      matrix2[j] = Math.floor(Math.random() * 9);
    }
